...
if($_POST['funcion']=='buscar_lotes_riesgo'){
    $lote->buscar_todos_lotes(); // Usar método específico para obtener todos los lotes
    $json=array();
    date_default_timezone_set('America/Bogota');
    $fecha = date('Y-m-d H:i:s');
    $fecha_actual = new DateTime($fecha);
    
    // Debug: contar lotes obtenidos
    $total_lotes = count($lote->objetos);
    //error_log("Total lotes encontrados: " . $total_lotes);
    ...
    // Debug: contar alertas generadas
    $total_alertas = count($json);
    //error_log("Total alertas generadas: " . $total_alertas);
